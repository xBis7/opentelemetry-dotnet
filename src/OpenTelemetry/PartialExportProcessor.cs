...
public abstract class PartialExportProcessor<T> : BaseExportProcessor<T>
    where T : class
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PartialExportProcessor{T}"/> class.
    /// </summary>
    /// <param name="exporter">Exporter instance.</param>
    /// <param name="logProcessor">Log processor instance.</param>
    ...
    protected PartialExportProcessor(
        BaseExporter<T> exporter,
        BaseExportProcessor<LogRecord> logProcessor, // TODO: change the generic type.
        ...
        : base(exporter)
    {
        ...
        {
            IsBackground = true,
            Name = $"OpenTelemetry-{nameof(PartialExportProcessor<T>)}-{exporter.GetType().Name}",
        };
